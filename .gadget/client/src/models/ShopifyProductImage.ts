...
/** 
* Produce a type that holds only the selected fields (and nested fields) of "Shopify Product Image". The present fields in the result type of this are dynamic based on the options to each call that uses it. 
...
/** All the actions available at the collection level and record level for "Shopify Product Image" */
export class ShopifyProductImageManager {
  constructor(readonly connection: GadgetConnection) {}

  
    /**
 * Finds one Shopify Product Image by ID. Returns a Promise that resolves to the record if found and rejects the promise if the record isn't found.
 **/
findOne: {
  ...
  },
  {
    ...
    selectionType: {} as AvailableShopifyProductImageSelection,
    optionsType: {} as FindOneShopifyProductImageOptions,
    schemaType: null as Query["shopifyProductImage"],
  } as const
)
...
maybeFindOne: {
  ...
  },
  {
    ...
    defaultSelection: DefaultShopifyProductImageSelection,
    selectionType: {} as AvailableShopifyProductImageSelection,
    optionsType: {} as MaybeFindOneShopifyProductImageOptions,
    schemaType: null as Query["shopifyProductImage"],
  } as const
)
    ...
    /**
 * Finds many Shopify Product Image. Returns a `Promise` for a `GadgetRecordList` of objects according to the passed `options`. Optionally filters the returned records using `filter` option, sorts records using the `sort` option, searches using the `search` options, and paginates using the `last`/`before` and `first`/`after` pagination options.
 **/
findMany: {
  ...
  },
  {
    ...
    defaultSelection: DefaultShopifyProductImageSelection,
    selectionType: {} as AvailableShopifyProductImageSelection,
    optionsType: {} as FindManyShopifyProductImagesOptions,
    schemaType: null as Query["shopifyProductImage"],
  } as const
);
  
    /**
 * Finds the first matching Shopify Product Image. Returns a `Promise` that resolves to a record if found and rejects the promise if a record isn't found, according to the passed `options`. Optionally filters the searched records using `filter` option, sorts records using the `sort` option, searches using the `search` options, and paginates using the `last`/`before` and `first`/`after` pagination options.
 **/
findFirst: {
  ...
  },
  {
    ...
    defaultSelection: DefaultShopifyProductImageSelection,
    selectionType: {} as AvailableShopifyProductImageSelection,
    optionsType: {} as FindFirstShopifyProductImageOptions,
    schemaType: null as Query["shopifyProductImage"],
  } as const
);
  
    /**
 * Finds the first matching Shopify Product Image. Returns a `Promise` that resolves to a record if found, or null if a record isn't found, according to the passed `options`. Optionally filters the searched records using `filter` option, sorts records using the `sort` option, searches using the `search` options, and paginates using the `last`/`before` pagination options.
 **/
maybeFindFirst: {
  ...
  },
  {
    ...
    defaultSelection: DefaultShopifyProductImageSelection,
    selectionType: {} as AvailableShopifyProductImageSelection,
    optionsType: {} as MaybeFindFirstShopifyProductImageOptions,
    schemaType: null as Query["shopifyProductImage"],
  } as const
);
