import { Client } from "@gadget-client/seasonify";
...
export interface AmbientContext {
    ...
    sessionID?: string;
    /** All Seasonify configuration values */
    config: AppConfiguration;
    /** A map of connection name to instantiated connection objects for Seasonify */
    connections: AppConnections;
    /** A high performance structured logger which writes logs to the Logs Viewer in the Gadget Editor. */
    logger: FastifyLoggerInstance;
    /**
     * An instance of the API client for Seasonify.
     *
...
/** A generic interface for an object that doesn't have a commmited a public interface. */
