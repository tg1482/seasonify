/**
 * Effect code for global action daily_update
 * @param { import("gadget-server").DailyUpdateGlobalActionContext } context - Everything for running this effect, like the api client, current record, params, etc
 */
